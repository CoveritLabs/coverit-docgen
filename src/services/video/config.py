...
def get_video_render_config() -> VideoRenderConfig:
    ...
    return VideoRenderConfig(
        ...
        window_focus_zoom=settings.video_focus_zoom,
        phase_rest_intro=settings.video_rest_intro_seconds,
        phase_zoom_in=settings.video_zoom_in_seconds,
        phase_cursor_move=settings.video_cursor_move_seconds,
        phase_action_hold=settings.video_action_hold_seconds,
        phase_zoom_out=settings.video_zoom_out_seconds,
        phase_rest_outro=settings.video_rest_outro_seconds,
        phase_focus_pan=settings.video_focus_pan_seconds,
        camera_sticky_enabled=settings.video_sticky_camera_enabled,
        camera_sticky_max_distance_px=settings.video_sticky_max_distance_px,
        camera_sticky_max_axis_ratio=settings.video_sticky_max_axis_ratio,
        click_press_frames=settings.video_click_press_frames,
        click_press_scale_min=settings.video_click_press_scale_min,
        focus_padding=settings.video_focus_padding,
    )
