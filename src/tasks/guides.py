...
from src.models.guides import UserGuideInput
...
async def task_generate_user_guide(ctx: dict, payload: dict) -> dict:
    ...
    try:
        ...
        return {"status": "success", "lastError": "No Error", "userGuide": guide}

    except Retry:
        # Let ARQ retry mechanism work normally
        raise

    except Exception as exc:
        logger.exception("Failed generating user guide")
