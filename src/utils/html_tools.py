...
def get_direction(dx: float, dy: float) -> str:
    ...
    directions = [
        ("right", 337.5, 360), ("right", 0, 22.5),
        ("bottom-right", 22.5, 67.5), ("bottom", 67.5, 112.5),
        ("bottom-left", 112.5, 157.5), ("left", 157.5, 202.5),
        ("top-left", 202.5, 247.5), ("top", 247.5, 292.5),
